  ...
  return (
    <section id="achievements" className="py-32 px-6 max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="relative group p-8 md:p-12 bg-navy border border-amber rounded-sm overflow-hidden glow-amber hover:glow-amber-strong transition-all duration-500">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8">
            <div className="p-4 bg-black border border-amber/30 rounded-full flex-shrink-0">
              <IconTrophy size={48} className="text-amber" />
            </div>
            ...
            <div className="text-center md:text-left">
              ...
              <p className="font-mono text-grey text-base md:text-lg">
                at VISTA 2026 — Recognized for creative implementation and
